...
// Only the catalogue page sends this, and only to lift the restriction its
// mode would otherwise apply. Everything else keeps the per-mode rule.
$availability = GETPOST('availability', 'aZ09') === 'all' ? 'all' : '';
